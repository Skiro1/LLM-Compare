...
- **Повторные попытки API с задержкой** — запросы автоматически повторяются при ошибках (1с → 2с → 4с)
- **Авторесайз textarea** — текстовые поля автоматически расширяются по высоте содержимого
